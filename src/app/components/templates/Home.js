  ...
  return (
    <main className="z-1 relative text-white py-16 lg:py-8 px-4 text-center bg-black bg-opacity-60 min-h-svh lg:flex lg:gap-10 lg:justify-center lg:items-center">
      ...
      <div className="lg:w-3/6 lg:pr-16">
        <a className="mt-8 lg:mt-0 max-w-80 mx-auto flex justify-center items-center" target="_blank" href="https://instagram.com/burlesqueriarj">
        ...
        <div className="flex justify-center mt-8">
          <blockquote className="instagram-media w-full" data-instgrm-permalink="https://www.instagram.com/burlesqueriarj" data-instgrm-version="14"></blockquote>
